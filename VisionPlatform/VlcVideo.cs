...
namespace VisionPlatform
{
    public class VlcPlayerBase
    {
        ...
        {
            //F:\0-多线插壳\2-最新软件版本\Hi.YiXin.MultiTM\VisionPlatform\bin\x64\Debug\libvlc\win-x64
            pluginPath = Environment.CurrentDirectory + "\\libvlc\\win-x64" + "\\plugins\\";  //插件目录
        ...
        public void TakeSnapshot(string sSavePath)
        {
            StringBuilder sMYSavePath = new StringBuilder(sSavePath);
            StringBuilder file_path = new StringBuilder(string.Format("{0}\\{1}.png", AppDomain.CurrentDomain.BaseDirectory, DateTime.Now.ToString("yyyyMMddHHmmssfff")));
            int iNum = LibVlcAPI.libvlc_video_take_snapshot(libvlc_media_player_, 0, sMYSavePath, 0, 0);
        }
        ...
        { get { return LibVlcAPI.libvlc_get_version(); } }
    }
    ...
    internal static class LibVlcAPI
    {
        ...
        [DllImport("libvlc", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        [SuppressUnmanagedCodeSecurity]
        public static extern int libvlc_video_take_snapshot(IntPtr libvlc_media_player
            , uint num, StringBuilder file_path, uint width, uint height);
        ...
        [SuppressUnmanagedCodeSecurity]
        public static extern long libvlc_media_player_get_state(IntPtr libvlc_mediaplayer);

        //[DllImport("libvlc", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true, CharSet = CharSet.Ansi)]
        //[SuppressUnmanagedCodeSecurity]
        //public static extern long libvlc_state_t(IntPtr libvlc_mediaplayer);
    }

    #endregion vlclib.dll
