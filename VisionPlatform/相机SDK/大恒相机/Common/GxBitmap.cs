                ...
                __UpdateBufferSize(objIBaseData);
                    ...
                    if (null != objIBaseData)
                    {
                        ...
                        if (GX_FRAME_STATUS_LIST.GX_FRAME_STATUS_SUCCESS == objIBaseData.GetStatus())
                        {
                            ...
                            m_myFun.GetImageFromCam(EnumData.CamColor.color, pBufferColor, m_nWidth, m_nHeigh);
                            }
                            else
                            {
                            ...
                            m_myFun.GetImageFromCam(EnumData.CamColor.mono, pBufferMono, m_nWidth, m_nHeigh);
